        ...
        <GridWrapper>
          <div className="mx-auto max-w-xl text-center md:mt-8">
            <p className="leading-8 text-text-secondary">
              Full Stack + AI, building and sharing on X.
            </p>
          </div>
        </GridWrapper>
        <GridWrapper>
            ...
            >
              <div className="group inline-block text-center">
                <div className="h-28 w-28 rounded-[20px] border border-border-primary bg-bg-primary p-2 transition-all duration-300 group-hover:-translate-y-3 group-hover:border-indigo-400">
                  ...
                  <p className="mt-3 text-sm text-text-secondary">Twitter</p>
                </div>
              </div>
            </a>
            <a
            ...
            >
              <div className="group inline-block text-center">
                <div className="h-28 w-28 rounded-[20px] border border-border-primary bg-bg-primary p-2 transition-all duration-300 group-hover:-translate-y-3 group-hover:border-indigo-400">
                  ...
                  <p className="mt-3 text-sm text-text-secondary">LinkedIn</p>
                </div>
              </div>
            </a>
            <a
              ...
              <div className="group inline-block text-center">
                <div className="h-28 w-28 rounded-[20px] border border-border-primary bg-bg-primary p-2 transition-all duration-300 group-hover:-translate-y-3 group-hover:border-indigo-400">
                  <div
                    ...
                    style={{ boxShadow: "0px 2px 1.5px 0px #A5AEB852 inset" }}
                  >
                    <GitHubIcon className="h-10 w-10 text-indigo-500" />
                  </div>
                  <p className="mt-3 text-sm text-text-secondary">GitHub</p>
                </div>
              </div>
            </a>
          </div>
