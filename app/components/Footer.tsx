...
const footerSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "https://x.com/adxtyahq", label: "On X", isExternal: true },
            ...
            <div className="flex w-full py-6 text-sm">
              <div>
                <div className="flex-grow space-y-6">
                  ...
                  <p className="w-60 leading-5 text-text-secondary">
                    I&apos;m Aditya, a full stack developer building SaaS and AI
                    products. Thanks for stopping by!
                  </p>
                </div>
                <p className="mt-6 text-text-secondary">
                  © {new Date().getFullYear()} Aditya Jha
                </p>
              </div>
