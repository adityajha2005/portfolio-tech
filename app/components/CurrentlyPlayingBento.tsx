...
export function CurrentlyPlayingBento() {
  ...
  if (isLoading) {
    return (
      <div className="group relative col-span-5 row-span-6 flex h-[220px] flex-col overflow-hidden rounded-2xl border border-border-primary p-6 hover:bg-surface-hover">
