...
function DesktopNav() {
  ...
  const determineActiveClass = (link: string): string => {
    return path === link ? "text-text-primary" : "text-text-secondary";
  };
  ...
  return (
    ...
    >
      ...
      <ul className="flex place-items-center space-x-4 rounded-full border border-border-primary px-5 py-2 text-sm text-text-secondary">
