...
export function AboutSection(): React.ReactNode {
  return (
    <section className="space-y-16">
      ...
      <HorizontalLine />
      <div className="grid grid-cols-1 grid-rows-[14] gap-2 md:grid-cols-12">
        <div className="group relative col-span-5 row-span-6 flex h-[220px] flex-col overflow-hidden rounded-2xl border border-border-primary p-6 hover:bg-surface-hover"></div>
