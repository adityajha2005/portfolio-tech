...
export function ToolboxBento({ linkTo }: { linkTo?: string }) {
  return (
    <BentoCard linkTo={linkTo} height="md:h-[304px] lg:h-[300px]">
      <div className="group-hover:from-surface-hover absolute inset-y-0 left-0 z-20 w-1/5 bg-gradient-to-r from-bg-primary to-transparent"></div>
      <div className="group-hover:from-surface-hover absolute inset-y-0 right-0 z-20 w-1/5 bg-gradient-to-l from-bg-primary to-transparent"></div>
