...
export function ReactionBreakdown({
  ...
  const cardClassName = "group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border-primary bg-bg-primary p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-surface-hover";
        ...
        <div className="relative z-20 flex h-full flex-col">
          ...
          <div className="grid flex-1 grid-cols-2 gap-3">
            {(Object.keys(REACTION_CONFIG) as ReactionType[]).map((type) => {
              ...
              return (
                <div key={type} className={`flex flex-col items-center justify-center rounded-xl border border-border-primary/50 p-3 bg-bg-secondary/50`}>
                  <div className="mb-2">
