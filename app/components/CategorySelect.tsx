      ...
      <div className="mt-3 sm:mt-4">
        <div className="grid grid-cols-1 lg:hidden">
          <select
            ...
            className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-2 pl-3 pr-8 text-base text-text-primary outline outline-1 -outline-offset-1 outline-border-primary focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-slate-600"
          >
